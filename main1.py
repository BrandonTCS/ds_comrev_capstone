...
##        date = review.find_element(By.TAG_NAME,
##            'authorJobTitle').get_attribute('datetime')
...
##                'authorJobTitle middle common__EiReviewDetailsStyle__newGrey').text
##            except Exception:
...
def sign_in():
    ...
    url = 'https://www.glassdoor.sg/profile/login_input.htm?userOriginHook=HEADER_SIGNIN_LINK'
    browser.get(url)
    # import pdb;pdb.set_trace()
